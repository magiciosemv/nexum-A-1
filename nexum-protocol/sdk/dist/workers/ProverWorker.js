    ...
    switch (msg.type) {
        ...
        case "PROVE": {
            ...
            try {
                ...
                const { proof, publicSignals } = await snarkjs.groth16FullProve(input, wasm_path, zkey_path);
...
function writeBigIntLE(buf, n, offset, len) {
    for (let i = 0; i < len; i++) {
